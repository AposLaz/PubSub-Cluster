...
var auth = __importStar(require("../auth/index"));
var PublishException_1 = __importDefault(require("../data/PublishException"));
...
var PublisherClient = /** @class */ (function () {
    function PublisherClient(uri) {
        this.httpKeepAliveAgent = new agentkeepalive_1.default();
        this.httpsKeepAliveAgent = new agentkeepalive_1.HttpsAgent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _b.sent();
                        throw new PublishException_1.default('Bad URI', { statusCode: -2 });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new PublishException_1.default(err_1.message, { statusCode: -1 });
                    case 4:
                        context = {
    ...
    PublisherClient.prototype._finishHttpRequest = function (mode, httpData, context) {
        ...
        if (mode === 'end') {
            if (context.statusCode < 200 || context.statusCode >= 300) {
                throw new PublishException_1.default(JSON.stringify(context.httpBody), context);
            }
        }
        else if (mode === 'close') {
