...
var WebSocketMessageFormat = /** @class */ (function () {
    function WebSocketMessageFormat(content, close, code) {
    ...
    // be closed.
    WebSocketMessageFormat.prototype.export = function () {
        var obj = {};
        if (this.close) {
            obj['action'] = 'close';
            if (this.code != null) {
            ...
            if (buffer_1.Buffer.isBuffer(this.content)) {
    ...
    return WebSocketMessageFormat;
}());
exports.default = WebSocketMessageFormat;
//# sourceMappingURL=WebSocketMessageFormat.js.map