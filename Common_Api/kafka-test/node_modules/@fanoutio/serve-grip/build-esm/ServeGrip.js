...
import { GripInstruct, Publisher, getWebSocketContextFromReq, encodeWebSocketEvents, isWsOverHttp, validateSig, Auth, Channel, ConnectionIdMissingException, WebSocketDecodeEventException, } from '@fanoutio/grip';
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (gripSigHeader_1 !== undefined) {
                            ...
                            if (clients.length > 0) {
                                if (clients.every(function (client) { return client.auth instanceof Auth.Jwt && client.auth.key != null; })) {
                                    needsSigned = true;
                                    ...
                                    if (clients.some(function (client) {
                                        return validateSig(gripSigHeader_1, client.auth.key);
                                    })) {
                                        isProxied_1 = true;
                                        isSigned = true;
                                    }
                        ...
                        wsContext_1 = null;
                        if (!isWsOverHttp(req)) return [3 /*break*/, 5];
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, getWebSocketContextFromReq(req, this.prefix)];
                    case 3:
                        wsContext_1 = _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        ex_1 = _a.sent();
                        if (ex_1 instanceof ConnectionIdMissingException) {
                            debug("ERROR - connection-id header needed. Send Error, returning false");
                            res.statusCode = 400;
                            res.end('WebSocket event missing connection-id header.\n');
                            return [2 /*return*/, false];
                        }
                        if (ex_1 instanceof WebSocketDecodeEventException) {
                                ...
                                startInstruct: function () {
                                    try {
                                        ...
                                        if (wsContext_1 == null && isProxied_1) {
                                            ...
                                            gripInstruct_1 = new GripInstruct();
                        ...
                        if (wsContext_1 != null) {
                            ...
                            res.writeHead = function (statusCode, reason, obj) {
                                ...
                                if (gripInstruct_1 != null) {
                                    ...
                                    gripInstruct_1.channels = gripInstruct_1.channels.map(function (ch) { return new Channel(_this.prefix + ch.name, ch.prevId); });
