...
var Item = /** @class */ (function () {
    function Item(formats, id, prevId) {
    ...
    Item.prototype.export = function () {
        ...
        var alreadyUsedFormatNames = new Set();
        for (var _i = 0, _a = this.formats; _i < _a.length; _i++) {
            var format = _a[_i];
            var name_1 = format.name();
            if (alreadyUsedFormatNames.has(name_1)) {
                throw new Error("More than one instance of " + name_1 + " specified");
            }
